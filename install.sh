...
require_lib_bundle() {
  ...
  if [ "${SPEEDTEST_SH_VERSION:-}" != "1.0" ] && [ "${SPEEDTEST_SH_VERSION:-}" != "1.1" ] && [ "${SPEEDTEST_SH_VERSION:-}" != "1.2" ] && [ "${SPEEDTEST_SH_VERSION:-}" != "1.3" ] && [ "${SPEEDTEST_SH_VERSION:-}" != "1.4" ] && [ "${SPEEDTEST_SH_VERSION:-}" != "1.5" ] && [ "${SPEEDTEST_SH_VERSION:-}" != "1.6" ] && [ "${SPEEDTEST_SH_VERSION:-}" != "1.7" ] && [ "${SPEEDTEST_SH_VERSION:-}" != "1.8" ] && [ "${SPEEDTEST_SH_VERSION:-}" != "1.9" ]; then
